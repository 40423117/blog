...
s.text(180,100, '點按一下圖形').attr({'fill' : 'blue',  'stroke': 'blue', 'stroke-width': 0.5 })
...
def onSVGLoaded(data):
    ...
    g.text(300,100, '將滑鼠指向我')
 
# 利用 window.Snap.load 載入 svg 檔案
tux = window.Snap.load("http://40423117.github.io/blog_data/files/snap.svg", onSVGLoaded)
g.transform('t180,20')
